...
This repository contains the analysis code used to evaluate metabolomics data for binary classification of cancer/control samples using Random Forest models and Gini index–based feature importance.
